...
describe('geometry', function () {
	...
	describe('Rect', function () {
		...
		it('constructorWithPoints', function () {
			const r = new Rect(new Point(5, 3), new Point(12, 14));
			assert.isOk(r instanceof Rect);
			assert.equal(r.getTop(), 3);
			assert.equal(r.getLeft(), 5);
			assert.equal(r.getWidth(), 7);
		...
		it('subRect', function () {
			const r = new Rect(3, 5, 7, 11);
			assert.isOk(r instanceof Rect);
			const s = r.subRect(0.909, 0.857, 0.091, 0.143);
			const d = 0.005;
		...
		it('subRect2', function () {
			const r = new Rect(0, 0, 460, 320);
			assert.isOk(r instanceof Rect);
			const s = r.subRect(0.95, 0.7, 0.2, 0.1);
			const d = 0.005;
