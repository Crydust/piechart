...
define(['app/geometry'], function (geometry) {
    ...
    QUnit.test('constructorWithNumbers', 8, function (assert) {
    ...
    QUnit.test('constructorWithPoints', 8, function (assert) {
    ...
    QUnit.test('subRect', 8, function (assert) {
        var r = new geometry.Rect(3, 5, 7, 11);
        assert.ok(r instanceof geometry.Rect);
    ...
    QUnit.test('subRect2', 8, function (assert) {
